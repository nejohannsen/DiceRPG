class ConceptsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @concept.save
        format.html { redirect_to edit_character_path(@concept.character), notice: 'Concept was successfully created.' }
  ...
  def update
    ...
    respond_to do |format|
      if @concept.update(concept_params)
        format.html { redirect_to edit_character_path(@concept.character), notice: 'Concept was successfully updated.' }
  ...
  private
    ...
    def concept_params
      params.require(:concept).permit(:title, :description)
    end
end
