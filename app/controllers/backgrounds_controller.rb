class BackgroundsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @background.save
        format.html { redirect_to edit_character_path(@background.character), notice: 'Background was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @background.update(background_params)
        format.html { redirect_to edit_character_path(@background.character), notice: 'Background was successfully updated.' }
